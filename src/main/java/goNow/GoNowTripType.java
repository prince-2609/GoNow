...
public class GoNowTripType 
{
	public static void flightTriptype(String TripType,String Trip,String OriginCityCode,String OriginLocation,String DestinationCityCode,String DestinationLocation,
			...
			String ShowDirectFlight) throws Exception 
	{
		...
		if(TripType.equalsIgnoreCase("OneWay"))
		{
			...
			while(true)
			{
				String text = QaBrowser.driver.findElement (By.xpath("//div[@class='datepick-month-header']")).getText();
				...
				{
					QaBrowser.driver.findElement(By.xpath("//a[@title='Show the next month']")).click();
				}
			}
			
			List<WebElement> allDates = QaBrowser.driver.findElements(By.xpath("/html/body/div[7]/div/div[2]/div/table/tbody/tr/td"));
			...
			QaRobot.selectValueFromDropdown("Adult", adult, "<b><i>Select adult for booking</i></b>");
			Thread.sleep(2000);

			QaRobot.selectValueFromDropdown("Child", child, "<b><i>Select child for booking</i></b>");
			Thread.sleep(2000);

			QaRobot.selectValueFromDropdown("Infant", infant, "<b><i>Select infant for booking</i></b>");
			Thread.sleep(2000);
		...
		else if(TripType.equalsIgnoreCase("RoundTrip"))
		{
			...
			QaBrowser.driver.findElement(By.xpath("//div[@id='flight_tb1']/div[1]/div/div/div[3]/div/div[1]/span/span/img")).click();
			Thread.sleep(2000);
			...
			QaBrowser.driver.findElement(By.xpath("//img[@id='imagearrival']")).click();
			Thread.sleep(2000);
			
			while(true)
			{
				String text1 = QaBrowser.driver.findElement (By.xpath("//div[@class='datepick-month-header']")).getText();
			...
			List<WebElement> allDates1 = QaBrowser.driver.findElements(By.xpath("/html/body/div[7]/div/div[2]/div/table/tbody/tr/td"));
	...
	public static void hotelTrip(String CityCode,String CityTitle,String CheckInDate,String CheckOutDate,String Rooms,String Adult,String Child,
			String ChildAge,String MoreOptions,String Nationality,String Currency,String StarRating) throws Exception 
	{
			...
			QaBrowser.driver.findElement(By.xpath("//div[@id='hm_tab3']/div/div/div[1]/div/div/div[2]/span/span/img")).click();
			Thread.sleep(2000);
			...
			while(true)
			{
				String text2 = QaBrowser.driver.findElement (By.xpath("/html/body/div[7]/div/div[2]/div/div")).getText();
			...
			List<WebElement> allDates2 = QaBrowser.driver.findElements(By.xpath("/html/body/div[7]/div/div[2]/div/table/tbody/tr/td"));
			...
			QaBrowser.driver.findElement(By.xpath("//div[@id='hm_tab3']/div/div/div[1]/div/div/div[3]/span/span/img")).click();
			Thread.sleep(2000);
			
			while(true)
			{
				String text3 = QaBrowser.driver.findElement (By.xpath("/html/body/div[7]/div/div[2]/div/div")).getText();
			...
			List<WebElement> allDates3 = QaBrowser.driver.findElements(By.xpath("/html/body/div[7]/div/div[2]/div/table/tbody/tr/td"));
			...
			String ChangeCheckIn,String ChangeCheckOut) throws Exception 
	{
			...
			QaBrowser.driver.findElement(By.xpath("//div[@id='hm_tab4']/div/div/div[1]/div/div/div[2]/div/div[1]/span/span/img")).click();
			Thread.sleep(2000);
			
			while(true)
			{
				String text = QaBrowser.driver.findElement (By.xpath("/html/body/div[7]/div/div[2]/div[1]/div")).getText();
			...
			List<WebElement> allDates = QaBrowser.driver.findElements(By.xpath("/html/body/div[7]/div/div[2]/div[1]/table/tbody/tr/td"));
			...
			QaBrowser.driver.findElement(By.xpath("//div[@id='hm_tab4']/div/div/div[1]/div/div/div[2]/div/div[2]/span/span/img")).click();
			Thread.sleep(2000);
			
			while(true)
			{
				String text1 = QaBrowser.driver.findElement (By.xpath("/html/body/div[7]/div/div[2]/div[1]/div")).getText();
			...
			List<WebElement> allDates1 = QaBrowser.driver.findElements(By.xpath("/html/body/div[7]/div/div[2]/div[1]/table/tbody/tr/td"));
