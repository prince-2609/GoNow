	...
	public static void selectDateInCalendarOneWay(String Day,String Month,String Year) throws ParseException
	 {
		...
		String monthYear = QaBrowser.driver.findElement (By.xpath("/html/body/div[7]/div/div[2]/div/div")).getText();
		...
		else
		{
			while(!(month.equals(Month) && year.equals(Year)))
			{
				...
				monthYear = QaBrowser.driver.findElement (By.xpath("/html/body/div[7]/div/div[2]/div/div")).getText();
	...
	public static void selectDateInCalendarRoundTrip(String Day,String Month,String Year,String Day1,String Month1,String Year1) throws InterruptedException, ParseException
	 {
		...
		else
		{
			while(!(month.equals(Month) && year.equals(Year)))
			{
				...
				QaBrowser.driver.findElement(By.xpath("//div[@id='flight_tb1']/div[1]/div/div/div[3]/div/div[2]/span/span/img")).click();
				Thread.sleep(2000);
				
				String monthYear1 = QaBrowser.driver.findElement (By.xpath("/html/body/div[7]/div/div[2]/div/div")).getText();
				...
				else
				{
					while(!(month1.equals(Month1) && year1.equals(Year1)))
					{
						...
						monthYear1 = QaBrowser.driver.findElement (By.xpath("/html/body/div[7]/div/div[2]/div/div")).getText();
